...
- [Pipeline de dados](#pipeline-de-dados)
  ...
  - [Introdução ao Airflow](#introdução-ao-airflow)
  - [Utilização do docker operator no Airflow](#utilização-do-docker-operator-no-airflow)
  - [Frameworks de pipelines de dados](#frameworks-de-pipelines-de-dados)
  - [Arquitetura de pipeline de dados](#arquitetura-de-pipeline-de-dados)
  - [Feature Store](#feature-store)
  - [Otimizações de pipelines](#otimizações-de-pipelines)
- [Banco de dados colunar](#banco-de-dados-colunar)
  - [Introdução a OLAP](#introdução-a-olap)
...
- [Processamento em tempo real](#processamento-em-tempo-real)
  ...
  - [Kafka na prática](#kafka-na-prática)
      - [Produtores e consumidores](#produtores-e-consumidores)
      - [Construindo aplicações](#construindo-aplicações)
      - [Tópicos no Kafka](#tópicos-no-kafka)
      - [Roteamento de eventos](#roteamento-de-eventos)
      - [Manipulando streams](#manipulando-streams)
      - [Agregação de dados](#agregação-de-dados)
      - [União de dados](#união-de-dados)
      - [Operações com janelas](#operações-com-janelas)
      - [Conectando fontes de dados e sincronizadores](#conectando-fontes-de-dados-e-sincronizadores)
      - [Transformação de strem em evento](#transformação-de-strem-em-evento)
...
- [Spark](#spark)
  ...
  - [Spark no ambiente AWS](#spark-no-ambiente-aws)
  - [Tuning dos parâmetros do Spark](#tuning-dos-parâmetros-do-spark)
  - [Spark com Airflow e AWS](#spark-com-airflow-e-aws)
- [Data scrapping](#data-scrapping)
  - [Introdução a WEB scrapping com Python](#introdução-a-web-scrapping-com-python)
  - [Scrapy](#scrapy)
...
- https://pt.coursera.org/learn/relational-database-administration
...
- https://www.alura.com.br/curso-online-modelagem-banco-nosql

## Configuração e gerenciamento de um ambiente MongoDB
...
## Infraestrutura para pipelines de dados
...
- https://www.alura.com.br/curso-online-engenharia-dados-apache-airflow

## Utilização do docker operator no Airflow
- https://www.youtube.com/watch?v=aJlNgomMGYU
- https://towardsdatascience.com/using-apache-airflow-dockeroperator-with-docker-compose-57d0217c8219

## Frameworks de pipelines de dados
- https://www.youtube.com/watch?v=C6Abv87D5dU
...
## Feature Store
- https://medium.com/data-hackers/o-que-%C3%A9-feature-store-29e35c60dada
- https://www.hopsworks.ai/open-source-hopsworks
...
- https://okfnlabs.org/blog/2014/01/10/olap-introduction.html

## Diferenças entre bancos colunares e relacionais
- https://dzone.com/articles/the-data-processing-holy-grail-row-vs-columnar-dat

## Amazon Redshift
- https://www.xplenty.com/blog/data-warehousing-for-dummies-a-beginners-guide-to-setting-up-an-amazon-redshift-data-warehouse/
...
## Kafka na prática
- https://www.youtube.com/watch?v=j4bqyAMMb7o&list=PLa7VYi0yPIH0KbnJQcMv5N9iW8HkZHztH&index=3
- https://itnext.io/how-to-setup-kafka-cluster-for-15k-events-per-second-on-aws-using-docker-d34539873589
- https://github.com/confluentinc/cp-demo
- https://www.youtube.com/watch?v=dKw2hfmNwlE
- https://developer.confluent.io/learn-kafka/
- https://www.confluent.io/resources/kafka-the-definitive-guide/

#### Produtores e consumidores
- https://kafka-tutorials.confluent.io/kafka-console-consumer-producer-basics/confluent.html
...
- https://kafka-tutorials.confluent.io/kafka-console-consumer-read-specific-offsets-partitions/confluent.html
...
- https://kafka-tutorials.confluent.io/kafka-producer-callback-application/confluent.html
- https://kafka-tutorials.confluent.io/error-handling/confluent.html
- https://kafka-tutorials.confluent.io/produce-consume-lang/scala.html

#### Tópicos no Kafka
- https://kafka-tutorials.confluent.io/how-to-count-messages-on-a-kafka-topic/confluent.html
- https://kafka-tutorials.confluent.io/change-topic-partitions-replicas/ksql.html
- https://medium.com/@sannidhi.s.t/dead-letter-queues-dlqs-in-kafka-afb4b6835309

#### Roteamento de eventos
- https://kafka-tutorials.confluent.io/split-a-stream-of-events-into-substreams/confluent.html
- https://kafka-tutorials.confluent.io/merge-many-streams-into-one-stream/confluent.html
- https://kafka-tutorials.confluent.io/dynamic-output-topic/confluent.html
- https://kafka-tutorials.confluent.io/filter-a-stream-of-events/confluent.html
- https://kafka-tutorials.confluent.io/finding-distinct-events/confluent.html

#### Manipulando streams
- https://kafka-tutorials.confluent.io/kafka-streams-convert-to-ktable/confluent.html
- https://kafka-tutorials.confluent.io/rekey-a-stream/ksql.html
- https://kafka-tutorials.confluent.io/rekey-with-function/ksql.html
- https://kafka-tutorials.confluent.io/naming-stateful-operations/kstreams.html
- https://kafka-tutorials.confluent.io/handling-deserialization-errors/ksql.html
- https://kafka-tutorials.confluent.io/changing-serialization-format/ksql.html
- https://kafka-tutorials.confluent.io/kafka-streams-schedule-operations/kstreams.html
- https://kafka-tutorials.confluent.io/schedule-ktable-ttl/kstreams.html

#### Agregação de dados
- https://kafka-tutorials.confluent.io/create-stateful-aggregation-count/confluent.html
- https://kafka-tutorials.confluent.io/create-stateful-aggregation-sum/confluent.html
- https://kafka-tutorials.confluent.io/create-stateful-aggregation-minmax/ksql.html
- https://kafka-tutorials.confluent.io/aggregating-average/kstreams.html
- https://kafka-tutorials.confluent.io/cogrouping-streams/confluent.html

#### União de dados
- https://kafka-tutorials.confluent.io/join-a-stream-to-a-table/confluent.html
- https://kafka-tutorials.confluent.io/join-a-stream-to-a-stream/ksql.html
- https://kafka-tutorials.confluent.io/join-a-table-to-a-table/ksql.html
- https://kafka-tutorials.confluent.io/foreign-key-joins/kstreams.html
- https://kafka-tutorials.confluent.io/multi-joins/ksql.html

#### Operações com janelas
- https://kafka-tutorials.confluent.io/create-tumbling-windows/confluent.html
- https://kafka-tutorials.confluent.io/create-session-windows/confluent.html
...
- https://kafka-tutorials.confluent.io/window-final-result/kstreams.html
- https://kafka-tutorials.confluent.io/anomaly-detection/ksql.html
- https://kafka-tutorials.confluent.io/time-concepts/ksql.html

#### Conectando fontes de dados e sincronizadores
- https://kafka-tutorials.confluent.io/kafka-connect-datagen/confluent.html
- https://kafka-tutorials.confluent.io/generate-streams-of-test-data/ksql.html
- https://kafka-tutorials.confluent.io/connect-add-key-to-source/kstreams.html
- https://kafka-tutorials.confluent.io/connect-sink-timestamp/ksql.html

#### Transformação de strem em evento
- https://kafka-tutorials.confluent.io/transform-a-stream-of-events/confluent.html
...
- https://kafka-tutorials.confluent.io/flatten-nested-data/ksql.html

#### Manipulando valores
- https://kafka-tutorials.confluent.io/udf/ksql.html
- https://kafka-tutorials.confluent.io/concatenation/ksql.html
- https://kafka-tutorials.confluent.io/masking-data/ksql.html
- https://kafka-tutorials.confluent.io/column-difference/ksql.html
- https://kafka-tutorials.confluent.io/geo-distance/ksql.html
...
- https://aws.amazon.com/pt/blogs/big-data/best-practices-for-running-apache-spark-applications-using-amazon-ec2-spot-instances-with-amazon-emr/
- https://aws.amazon.com/pt/blogs/big-data/submitting-user-applications-with-spark-submit/
  
## Tuning dos parâmetros do Spark
- https://blog.cloudera.com/managing-cpu-resources-in-your-hadoop-yarn-clusters/
- https://aws.amazon.com/pt/blogs/big-data/best-practices-for-successfully-managing-memory-for-apache-spark-applications-on-amazon-emr/

## Spark com Airflow e AWS
- https://www.startdataengineering.com/post/how-to-submit-spark-jobs-to-emr-cluster-from-airflow/

# Data scrapping

## Introdução a WEB scrapping com Python
- https://pt.coursera.org/learn/python-network-data
- https://realpython.com/python-web-scraping-practical-introduction/

 ## Scrapy
 - https://www.youtube.com/watch?v=ALizgnSFTwQ
 - https://www.cloudsigma.com/how-to-crawl-a-web-page-with-scrapy-and-python-3/

 ## Extração de dados de redes sociais
 - https://pt.coursera.org/learn/social-media-data-analytics
